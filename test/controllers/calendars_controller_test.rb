...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference("Calendar.count") do
      post calendars_url, params: { calendar: { date_of_choice: @calendar.date_of_choice } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { date_of_choice: @calendar.date_of_choice } }
